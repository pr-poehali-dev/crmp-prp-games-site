        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6">
              {['home', 'about', 'servers', 'ratings', 'gallery', 'clans', 'donate', 'profile', 'contacts'].map((section) => (
                <button
                  key={section}
            ...
            <Button className="bg-gradient-to-r from-primary to-secondary hover-glow">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {activeSection === 'donate' && (
          <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
            <h2 className="text-4xl font-bold text-glow mb-6">Донат</h2>
            <div className="grid md:grid-cols-3 gap-4">
              {[
                { name: 'Стартовый', price: 299, benefits: ['100 кристаллов', 'Уникальный скин', 'VIP чат'] },
                { name: 'Продвинутый', price: 799, benefits: ['500 кристаллов', '3 эпических скина', 'Приоритет в очереди', 'Уникальный тег'] },
                { name: 'Легендарный', price: 1999, benefits: ['2000 кристаллов', '10 легендарных скинов', 'Личный саппорт', 'Эксклюзивные предметы', 'Все преимущества'] },
              ].map((pack, idx) => (
                <Card key={idx} className={`hover-glow ${idx === 1 ? 'border-primary card-glow' : ''}`}>
                  <CardHeader>
